...
const Footer = () => {
    ...
    return (
        <footer>
            ...
            {isDesktop ? (
                <div className="flex flex-row justify-center text-4xl md:text-9xl font-bold w-full translate-y-2 h-20 overflow-hidden gap-1 md:gap-4 -tracking-[0.02em]">
                    <div>ARYAN..</div>
                ...
                <div>
                    ...
                    <div className="flex justify-center text-6xl font-bold w-full translate-y-1 h-10 overflow-hidden gap-6 -tracking-[0.02em]">
                        <div>ARYAN</div>
                        <div>LUTHRA</div>
                    </div>
                </div>
