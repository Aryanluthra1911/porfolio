    ...
    return (
        <div className='w-full h-auto bg-[#111111] text-white pt-25 flex justify-center'>
            <div className='w-[90%] lg:w-[70%] h-auto flex flex-col justify-start items-start sm:items-center pt-6 space-y-10'>
                ...
                <Shinytxt 
                text={'I’m a passionate Full-Stack Web Developer who loves building scalable, user-friendly, and impactful digital solutions. With a strong command over both frontend and backend development, I enjoy turning ideas into reality—whether it’s crafting smooth user interfaces or developing efficient server-side logic.'} 
                className='w-[90%] text-lg sm:text-2xl' 
                speed={2}/>
                <Shinytxt 
                text={'My approach to development is user-first and performance-driven. I focus on writing clean, maintainable code and building products that not only work flawlessly but also deliver great experiences to the end users. Along with development, I also have an eye for UI/UX design, which helps me create solutions that are both functional and visually engaging.'} 
                className='w-[90%] text-lg sm:text-2xl' 
                speed={2}/>
                <Blurtxt 
                className='text-3xl sm:text-4xl sm:w-[90%] w:[90%] h-20 font-semibold items-center' 
                text='My Philosophy'
                />
                <Shinytxt 
                text={'I believe in continuous learning and problem-solving. Exploring new technologies and frameworks excites me, and I always aim to use the right tool for the job. For me, coding is not just about solving problems but about creating products that are efficient, scalable, and sustainable.'} 
                className='w-[90%] text-lg sm:text-2xl' 
                speed={2}/>
                <Shinytxt 
                text={'Outside of coding, I love exploring new tech trends, taking part in hackathons, and sharing knowledge with fellow developers.'} 
                className='w-[90%] text-lg sm:text-2xl' 
                speed={2}/>
                <Shinytxt 
                text={'I’m always open to collaborations, freelance projects, and exciting opportunities in web development. Let’s connect and build something impactful!'} 
                className='w-[90%] text-lg sm:text-2xl' 
                speed={2}/>
                <Blurtxt 
                className='text-3xl sm:text-4xl sm:w-[90%] w:[90%] h-20 font-semibold items-center' 
